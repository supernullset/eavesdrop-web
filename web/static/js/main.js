...
var _user$project$Main$initialModel = function (stream) {
	return {
		newMessage: '',
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							...
							'Join ',
							A2(_elm_lang$core$Basics_ops['++'], model.userStream, '\'s lobby')))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('fake incoming message')
									]))
							]))
					]))
			]));
...
var _user$project$Main$main = {
	...
	flags: A2(
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'userStream', _elm_lang$core$Json_Decode$string),
		function (userStream) {
