...
var _user$project$Main$renderMessage = function (str) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					function (_p0) {
						return _elm_lang$core$List$reverse(
							A2(_elm_lang$core$List$map, _user$project$Main$renderMessage, _p0));
					}(model.messages)),
				_1: {ctor: '[]'}
			}
		});
...
var _user$project$Main$initModel = function (stream) {
	return A4(
		_user$project$Main$Model,
		'',
		{ctor: '[]'},
		_user$project$Main$initPhxSocket(stream),
		stream);
};
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'userStream', _elm_lang$core$Json_Decode$string)));
